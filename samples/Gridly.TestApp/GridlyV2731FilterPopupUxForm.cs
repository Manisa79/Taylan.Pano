...
public sealed class GridlyV2731FilterPopupUxForm : Form
{
    ...
    public GridlyV2731FilterPopupUxForm()
    {
        Text = "Gridly v27.3.1 Filter Popup UX";
        Width = 1280;
        Height = 760;
    ...
    {
        _grid.Columns.Clear();
        _grid.Columns.Add(new GridlyColumn("Id", nameof(FilterPopupRow.Id), 64) { TextAlign = ContentAlignment.MiddleRight });
        _grid.Columns.Add(new GridlyColumn("RefDes", nameof(FilterPopupRow.RefDes), 90));
        _grid.Columns.Add(new GridlyColumn("Malzeme Kodu", nameof(FilterPopupRow.MaterialCode), 150));
        _grid.Columns.Add(new GridlyColumn("Uzun Malzeme Adı", nameof(FilterPopupRow.MaterialName), 420) { FillFreeSpace = true, WordWrap = true, MaxTextLines = 2 });
        _grid.Columns.Add(new GridlyColumn("Makine", nameof(FilterPopupRow.Machine), 110) { AllowGroup = true });
        _grid.Columns.Add(new GridlyColumn("Program / Klasör Yolu", nameof(FilterPopupRow.ProgramPath), 520) { FillFreeSpace = true, WordWrap = true, MaxTextLines = 2 });
        _grid.Columns.Add(new GridlyColumn("Durum", nameof(FilterPopupRow.Status), 110) { Kind = GridlyColumnKind.Badge, AllowGroup = true });
    }

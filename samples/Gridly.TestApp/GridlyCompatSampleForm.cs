...
public sealed class GridlyCompatSampleForm : Form
{
    ...
    public GridlyCompatSampleForm()
    {
        Text = "Gridly/GLV uyumluluk örnekleri - SetObjects / events / seçim / checked / sort";
        Width = 1100;
        Height = 680;
    ...
    {
        _grid.Columns.Add(new GridlyColumn("Seç", nameof(CompatRow.Checked), 54) { Kind = GridlyColumnKind.CheckBox, Editable = true });
        _grid.Columns.Add(new GridlyColumn("Id", nameof(CompatRow.Id), 70) { TextAlign = ContentAlignment.MiddleRight });
        _grid.Columns.Add(new GridlyColumn("Kod", nameof(CompatRow.Code), 130));
        _grid.Columns.Add(new GridlyColumn("Ad", nameof(CompatRow.Name), 220) { FillFreeSpace = true });
        _grid.Columns.Add(new GridlyColumn("Durum", nameof(CompatRow.State), 110));
        _grid.Columns.Add(new GridlyColumn("Oran", nameof(CompatRow.Rate), 90) { TextAlign = ContentAlignment.MiddleRight });
    }

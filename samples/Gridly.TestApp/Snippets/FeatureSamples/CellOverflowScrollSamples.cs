...
public static class CellOverflowScrollSamples
{
    ...
    public static GridlyView CreateCellOverflowScrollSample()
    {
        ...
        grid.Columns.Add(new GridlyColumn("Id", nameof(TicketNoteRow.Id), 70));
        grid.Columns.Add(new GridlyColumn("Makine", nameof(TicketNoteRow.Machine), 150));
        grid.Columns.Add(new GridlyColumn("Durum", nameof(TicketNoteRow.Status), 120));
        grid.Columns.Add(new GridlyColumn("Mesaj / Açıklama", nameof(TicketNoteRow.Message), 320)
        {
            WordWrap = true,
        ...
        grid.Columns.Add(new GridlyColumn("Teknisyen Notu", nameof(TicketNoteRow.TechnicianNote), 300)
        {
            WordWrap = true,
            AllowCellScroll = true,
            CellScrollMaxVisibleLines = 4,
        ...
        grid.Columns.Add(new GridlyColumn("Zaman", nameof(TicketNoteRow.Time), 150));

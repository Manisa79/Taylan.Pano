...
public static class UltimatePlatformSamples
{
    ...
    public static GridlyView CreateUltimateSample()
    {
        ...
        grid.Columns.Add(new GridlyColumn { Header = "Id", AspectName = "Id", Width = 70 });
        grid.Columns.Add(new GridlyColumn { Header = "Durum", AspectName = "Status", Width = 120 });
        grid.Columns.Add(new GridlyColumn { Header = "Makine", AspectName = "Machine", Width = 140 });
        grid.Columns.Add(new GridlyColumn { Header = "Öncelik", AspectName = "Priority", Width = 90 });
        grid.Columns.Add(new GridlyColumn { Header = "Başlık", AspectName = "Title", Width = 260 });
        grid.Columns.Add(new GridlyColumn { Header = "Yaş", Formula = "IF(Priority>=3,'Acil','Normal')", UseFormula = true, Width = 90 });
        ...
        grid.Actions.Add(new GridlyActionStep
        {

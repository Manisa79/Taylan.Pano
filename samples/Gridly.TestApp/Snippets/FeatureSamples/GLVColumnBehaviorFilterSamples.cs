...
public static class GLVColumnBehaviorFilterSamples
{
    ...
    public static FastGridlyView CreateDefaultFilterButtonSample()
    {
    ...
    public static FastGridlyView CreateDesignerLikeConfigurationSample()
    {
        ...
        grid.SetColumnFilter(new GridlyColumnFilter
        {
            AspectName = "Status",

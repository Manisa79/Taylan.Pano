...
partial class StartupLanguageForm
{
    ...
    private void InitializeComponent()
    {
        ...
        lblTitle.TabIndex = 0;
        lblTitle.Text = "Gridly TestApp Language";
        ...
        lblInfo.TabIndex = 1;
        lblInfo.Text = "Select the language used by Gridly built-in menus, dialogs and sample screens.";

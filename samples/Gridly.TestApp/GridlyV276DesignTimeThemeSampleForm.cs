...
public sealed class GridlyV276DesignTimeThemeSampleForm : Form
{
    private readonly GridlyView _grid;
    private readonly Label _info;

    public GridlyV276DesignTimeThemeSampleForm()
    {
        Text = "Gridly v27.6 - Design-Time Theme Sync";
        Width = 1120;
        Height = 720;
        ...
        {
            Dock = DockStyle.Fill,
            Text = "v27.6 Design-Time Theme Sync\nDesigner'da Gridly açık/VS uyumlu görünür; runtime tema butonlarıyla Light/Dark/Fluent test edilebilir.",
        ...
        _grid = new GridlyView
        {
            Dock = DockStyle.Fill,
            Name = "gridlyDesignTimeThemePreview",
            ThemePreset = GridlyThemePreset.System,
        ...
        AddButton(toolbar, "Runtime Light", () => _grid.ApplyTheme(GridlyTheme.LightTheme()));
        AddButton(toolbar, "Runtime Dark", () => _grid.ApplyTheme(GridlyTheme.DarkTheme()));
        AddButton(toolbar, "Runtime Fluent Light", () => _grid.ApplyTheme(GridlyTheme.FluentLightTheme()));
        ...
        _grid.SetObjects(new[]
        {
            ...
            new Row("Menü teması", "OK", "ContextMenuStrip ve Gridly built-in menüleri designer sync ile okunabilir kalır.", "90%"),

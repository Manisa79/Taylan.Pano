...
/// </summary>
public static class GridlyWindowChrome
{
    ...
    public static void Apply(Form form, GridlyTheme theme, bool preferGlassWhenAvailable = true)
    {
    ...
    public static void ApplyOnHandleCreated(Form form, Func<GridlyTheme> themeProvider, bool preferGlassWhenAvailable = true)
    {
    ...
    private static void ApplyCaptionColors(IntPtr hwnd, GridlyTheme theme)
    {
    ...
    private static void ApplyBackdrop(IntPtr hwnd, GridlyTheme theme, bool preferGlassWhenAvailable)
    {

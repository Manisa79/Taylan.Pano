...
/// <summary>
/// Shared visual polish for Gridly popup/dialog windows. Keeps helper windows consistent
/// with the active Gridly theme without forcing every form to duplicate button/textbox styling.
/// </summary>
public static class GridlyDialogThemeApplier
{
    public static void Apply(Control root, GridlyTheme theme)
    {
    ...
    public static void ApplyToControl(Control control, GridlyTheme theme)
    {
    ...
    public static Color NormalizePanelBack(GridlyTheme theme)
    {
    ...
    public static Color NormalizeControlBack(GridlyTheme theme)
    {
    ...
    public static Color NormalizePanelFore(GridlyTheme theme)
        => EnsureReadableTextColor(theme.ForeColor, NormalizePanelBack(theme));

    public static Color NormalizeControlFore(GridlyTheme theme)
    ...
    public static void PaintRoundedPanel(Graphics g, Rectangle bounds, GridlyTheme theme, int radius = 8)
    {

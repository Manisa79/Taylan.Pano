...
/// Gridly içindeki koyu/açık tema geçişlerinde düşük kontrastlı yazı, buton,
/// combo/textbox ve kart yüzeylerini merkezi olarak normalize eder.
/// </summary>
public static class GridlyThemeAccessibility
{
    public const double NormalTextRatio = 4.5d;
    public const double LargeTextRatio = 3.0d;
    public const double SurfaceRatio = 1.18d;

    public static GridlyTheme Normalize(GridlyTheme? source)
    {
        var t = source ?? GridlyTheme.LightTheme();
    ...
    public static Color ButtonBack(GridlyTheme theme, bool primary = false)
    {
    ...
    public static Color ButtonBorder(GridlyTheme theme, bool primary = false)
    {
        theme = Normalize(theme);

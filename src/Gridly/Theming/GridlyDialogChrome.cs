...
/// <summary>
/// Standardizes Gridly helper/dialog windows so popup forms, chooser windows and
...
/// </summary>
public enum GridlyDialogIconKind
{
    None,
    Grid,
    Filter,
...
public static class GridlyDialogChrome
{
    ...
    /// </summary>
    public static void ConfigureStandardDialog(Form form, GridlyTheme theme, int minimumWidth, int minimumHeight, bool sizeable = true, GridlyDialogIconKind iconKind = GridlyDialogIconKind.Grid)
    ...
    /// </summary>
    public static void ConfigureStandardDialog(Form form, GridlyTheme theme, int minimumSize, bool sizeable = true, GridlyDialogIconKind iconKind = GridlyDialogIconKind.Grid)
        => ConfigureStandardDialog(form, theme, new Size(Math.Max(1, minimumSize), Math.Max(1, minimumSize)), sizeable, iconKind);

    public static void ConfigureStandardDialog(Form form, GridlyTheme theme, Size minimumSize, bool sizeable = true, GridlyDialogIconKind iconKind = GridlyDialogIconKind.Grid)
    {
        ...
        form.ShowIcon = iconKind != GridlyDialogIconKind.None;
        ...
        GridlyWindowChrome.ApplyOnHandleCreated(form, () => theme, preferGlassWhenAvailable: true);
    ...
    public static void ApplyDialogIcon(Form form, GridlyTheme theme, GridlyDialogIconKind iconKind)
    {
        if (form is null || form.IsDisposed || iconKind == GridlyDialogIconKind.None) return;
        ...
        try
        {
            ...
            form.Icon = GridlyDialogIconFactory.Create(iconKind, theme);
            form.ShowIcon = true;
        }
        catch
        {
    ...
    public static void ConfigureOpenGridlyDialogs(Control root, GridlyTheme theme)
    {
        ...
        GridlyDialogThemeApplier.Apply(root, theme);
    }
}

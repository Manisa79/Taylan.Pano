...
public sealed class GridlyTheme
{
    ...
    // v28.14.2 compatibility aliases used by newer Gridly popup/dialog helpers.
    ...
    public static GridlyTheme LightTheme() => new()
    {
    ...
    public static GridlyTheme DarkTheme() => new()
    {
    ...
    public static GridlyTheme FluentLightTheme()
    {
        var t = LightTheme();
    ...
    public static GridlyTheme FluentDarkTheme()
    {
        var t = DarkTheme();
        t.UseFluentBackdrop = true;
        t.UseAcrylicEffect = true;
    ...
    public static GridlyTheme FromParentColor(Color parentBackColor, Color parentForeColor)
    {
        ...
        t.IsDark = dark;
        return GridlyThemeAccessibility.Normalize(t);
    }
    ...
    public static GridlyTheme FromPreset(GridlyThemePreset preset) => GridlyThemeAccessibility.Normalize(preset switch
    {
        GridlyThemePreset.System => WindowsThemeService.CurrentTheme(),
        GridlyThemePreset.Light => LightTheme(),
        GridlyThemePreset.Dark => DarkTheme(),
        GridlyThemePreset.FluentLight => FluentLightTheme(),
        GridlyThemePreset.FluentDark => FluentDarkTheme(),
        GridlyThemePreset.MidnightPurple => MidnightPurpleTheme(),
        GridlyThemePreset.SlateBlue => SlateBlueTheme(),
        GridlyThemePreset.Graphite => GraphiteTheme(),
        GridlyThemePreset.Emerald => EmeraldTheme(),
        GridlyThemePreset.WarmSand => WarmSandTheme(),
        GridlyThemePreset.Ocean => OceanTheme(),
        GridlyThemePreset.RoseQuartz => RoseQuartzTheme(),
        GridlyThemePreset.CyberNeon => CyberNeonTheme(),
        GridlyThemePreset.Nord => NordTheme(),
        GridlyThemePreset.Olive => OliveTheme(),
        GridlyThemePreset.Steel => SteelTheme(),
        _ => WindowsThemeService.CurrentTheme()
    });

    public static GridlyTheme MidnightPurpleTheme()
    {
        var t = DarkTheme();
    ...
    public static GridlyTheme SlateBlueTheme()
    {
        var t = DarkTheme();
    ...
    public static GridlyTheme GraphiteTheme()
    {
        var t = DarkTheme();
    ...
    public static GridlyTheme EmeraldTheme()
    {
        var t = LightTheme();
    ...
    public static GridlyTheme WarmSandTheme()
    {
        var t = LightTheme();
    ...
    public static GridlyTheme OceanTheme()
    {
        var t = DarkTheme();
    ...
    public static GridlyTheme RoseQuartzTheme()
    {
        var t = LightTheme();
    ...
    public static GridlyTheme CyberNeonTheme()
    {
        var t = DarkTheme();
    ...
    public static GridlyTheme NordTheme()
    {
        var t = DarkTheme();
    ...
    public static GridlyTheme OliveTheme()
    {
        var t = LightTheme();
    ...
    public static GridlyTheme SteelTheme()
    {
        var t = LightTheme();

...
public sealed class DateTimeCellEditor : ICellEditor
{
    public Control CreateEditor(Control owner, Rectangle bounds, GridlyColumn column, object row, object? value)
    {
        ...
        {
            Format = column.DateTimeFormat == GridlyDateTimeEditorFormat.Custom ? DateTimePickerFormat.Custom : DateTimePickerFormat.Short,
...
public enum GridlyDateTimeEditorFormat
{
    Short,
    Custom
}

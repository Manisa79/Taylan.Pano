...
public partial class GridlyView
{
    ...
    [DefaultValue(true)]
    [Description("Gridly içindeki kolon, filtre, kolon seçici, auto-size, gruplama ve header checkbox işlemlerini klavye kısayolları ile erişilebilir yapar.")]
    ...
    private bool HandleGridlyKeyboardAccessibilityShortcut(Keys keyData)
    {
    ...
    private GridlyColumn? GetKeyboardActiveColumn()
    {
    ...
    private void EnsureColumnVisibleByKeyboard(GridlyColumn col)
    {

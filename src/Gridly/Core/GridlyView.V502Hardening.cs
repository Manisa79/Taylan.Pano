...
public sealed class GridlyHardeningCheckResult
{
...
public partial class GridlyView
{
    ...
    public void ApplyGridly502HardeningDefaults()
    {
    ...
    public IReadOnlyList<GridlyHardeningCheckResult> RunGridly502RuntimeHardeningChecks()
    {
        var checks = new List<GridlyHardeningCheckResult>();

        checks.Add(new GridlyHardeningCheckResult
        {
            Area = "Theme",

...
public enum Gridly51UsageProfile
{
    AudixMedia,
    ThemeAudit,
    StabilityPilot
...
public sealed class Gridly51UsageCheckResult
{
...
{
    [Category("Gridly 5.1 - Real Usage")]
    [DefaultValue(true)]
    [Description("Gridly 5.1 gerçek kullanım pilot profilini etkinleştirir: Audix medya, tema audit ve stabilite kontrolleri.")]
    public bool EnableGridly51RealUsagePilot { get; set; } = true;
    ...
    public void ApplyGridly51RealUsageDefaults()
    {
        EnableGridly51RealUsagePilot = true;
        EnableAudix51MediaPilot = true;
        EnableTheme51Audit = true;

        ApplyGridly502HardeningDefaults();
    ...
    public void ApplyTheme51AuditDefaults(GridlyThemeStudioPreset preset = GridlyThemeStudioPreset.AudixDark)
    {
        EnableTheme51Audit = true;
    ...
    public IReadOnlyList<Gridly51UsageCheckResult> RunGridly51UsageChecks()
    {
        var result = new List<Gridly51UsageCheckResult>();

        result.Add(new Gridly51UsageCheckResult
        {
            Profile = "Audix",

...
/// <summary>Gridly hücre düzenleme tetikleme modu.</summary>
...
/// <summary>Gridly model filtresi kontratı.</summary>
public interface IGLVModelFilter
{
    bool Filter(object modelObject);
}

/// <summary>Delegate tabanlı Gridly model filtresi.</summary>
...
public partial class GridlyView
{
    ...
    private GridlyColumn? _secondarySortColumn;
    ...
    /// <summary>Gridly UseFiltering özelliği. Filtre menüsünü ve mevcut filtrelerin uygulanmasını kontrol eder.</summary>
    ...
    /// <summary>Gridly CheckBoxes özelliği. CheckedAspectName verilirse checkbox kolonu otomatik hazırlanır.</summary>
    [Category("Gridly - Compatibility")]
    [DefaultValue(false)]
    ...
    /// <summary>Gridly CheckedAspectName özelliği. Checkbox değerinin okunacağı/yazılacağı model property adıdır.</summary>
    [Category("Gridly - Compatibility")]
    [DefaultValue("")]
    ...
    /// <summary>Gridly CellEditActivation özelliği.</summary>
    [Category("Gridly - Compatibility")]
    ...
    /// <summary>Gridly AdditionalFilter özelliği. Func, Predicate ve IGLVModelFilter destekler.</summary>
    [Browsable(false)]
    ...
    /// <summary>Gridly tarafında güçlü tipli AdditionalFilter.</summary>
    [Browsable(false)]
    ...
    [Browsable(false)]
    public GridlyColumn? PrimarySortColumn
    {
        get => _sortColumn;
    ...
    [Browsable(false)]
    public GridlyColumn? SecondarySortColumn
    {
    ...
    /// <summary>Gridly ShowGroups özelliği. GroupByAspectName ile birlikte çalışır.</summary>
    [Category("Gridly - Compatibility")]
    [DefaultValue(false)]
    ...
    /// <summary>Gridly EmptyListMsg özelliği.</summary>
    [Category("Gridly - Compatibility")]
    ...
    public void Sort(GridlyColumn column, SortOrder order = SortOrder.Ascending)
    {
    ...
    public void Sort(GLVColumn column, SortOrder order = SortOrder.Ascending) => Sort((GridlyColumn)column, order);
    ...
    private const string InternalCheckBoxSelectorTag = "__GridlyInternalCheckBoxSelector";

    private static bool IsCompatibilityCheckBoxSelector(GridlyColumn column)
    {
        if (column == null || column.Kind != GridlyColumnKind.CheckBox) return false;
    ...
    private GridlyColumn? GetCompatibilityCheckBoxHostColumn()
    {
        if (!_checkBoxes) return null;

        // Gridly/ListView uyumu: liste seviyesindeki CheckBoxes = true davranışı
    ...
    private bool IsCompatibilityCheckBoxHostColumn(GridlyColumn? column)
    {
    ...
    private void NormalizeCompatibilityCheckBoxColumns()
    {
        ...
        if (host.Kind == GridlyColumnKind.CheckBox)
        {
            host.Kind = GridlyColumnKind.Text;
            host.Sortable = true;
        ...
        // Gridly/ListView hissi: checkbox ve metin aynı kolon içinde rahat görünmeli.
        if (host.Width < 120)
            host.Width = 160;

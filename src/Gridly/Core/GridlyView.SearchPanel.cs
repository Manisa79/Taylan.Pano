...
public partial class GridlyView
{
    ...
    public void ShowModernSearchPanel()
    {
        ...
        var form = new Form
        {
            Text = Gridly.Localization.GridlyText.T("Find"),
        ...
        GridlyDialogChrome.ConfigureStandardDialog(form, _theme, new Size(420, 150), sizeable: true, iconKind: GridlyDialogIconKind.Search);
        ...
        var search = new TextBox { Dock = DockStyle.Fill, PlaceholderText = Gridly.Localization.GridlyText.SearchPlaceholder };
        ...
        GridlyDialogThemeApplier.Apply(form, _theme);
    ...
    public void ShowToast(string message, GridlyToastKind kind = GridlyToastKind.Info, int milliseconds = 3500)
        => GridlyToast.Show(this, message, kind, _theme, milliseconds);
}

...
internal sealed class GridlyCommandPaletteForm : Form
{
    ...
    public GridlyCommandPaletteForm(GridlyView grid, string initialSearch)
    {
        _grid = grid;
        ...
        GridlyDialogChrome.ConfigureStandardDialog(this, theme, new Size(420, 320), sizeable: true, iconKind: GridlyDialogIconKind.Command);
        KeyPreview = true;

...
public enum GridlyMenuIconMode
{
    None = 0,
    BuiltIn = 1,
    Custom = 2,
...
public enum GridlyMenuIconSize
{
    Small16 = 16,
    Medium20 = 20,
    Large24 = 24
...
public partial class GridlyView
{
    ...
    [DefaultValue(GridlyMenuIconMode.BuiltIn)]
    [Description("Popup/context menülerde ikon gösterimini belirler. None: ikon yok, BuiltIn: Gridly ikonları, Custom: kullanıcı ikonları, BuiltInThenCustom: özel ikon varsa onu, yoksa yerleşik ikon.")]
    public GridlyMenuIconMode MenuIconMode { get; set; } = GridlyMenuIconMode.BuiltIn;

    [Category("Gridly - Menu Icons")]
    [DefaultValue(GridlyMenuIconSize.Small16)]
    public GridlyMenuIconSize MenuIconSize { get; set; } = GridlyMenuIconSize.Small16;
    ...
    [Category("Gridly - Menu Icons")]
    [DefaultValue(true)]
    [Description("Kullanıcı ContextMenuStrip verdiğinde Gridly otomatik eklenen alt menüye ve desteklenen öğelere ikon uygular.")]
    ...
    {
        if (items == null || MenuIconMode == GridlyMenuIconMode.None) return;
    ...
    private Image? ResolveMenuIcon(string key)
    {
        ...
        if (MenuIconMode is GridlyMenuIconMode.Custom or GridlyMenuIconMode.BuiltInThenCustom)
        {
            ...
            if (MenuIconMode == GridlyMenuIconMode.Custom) return null;
        }
    ...
    private Image? TryGetCustomMenuIconFromImageList(string key)
    {
        ...
        bool dark = MenuIconThemeMode == GridlyMenuIconTheme.Dark || (MenuIconThemeMode == GridlyMenuIconTheme.Auto && _theme.IsDark);
        bool light = MenuIconThemeMode == GridlyMenuIconTheme.Light || (MenuIconThemeMode == GridlyMenuIconTheme.Auto && !_theme.IsDark);

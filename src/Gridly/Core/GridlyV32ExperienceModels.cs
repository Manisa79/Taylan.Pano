...
/// </summary>
public enum GridlyExperiencePhase
{
    UxIntelligence = 38,
...
public enum GridlyMachineStatus
{
    Unknown,
    Running,
    Waiting,
...
public enum GridlyDocumentPreviewKind
{
    Auto,
    Image,
    Pdf,
...
public enum GridlyDashboardWidgetKind
{
    Kpi,
    Chart,
    Table,
...
public sealed class GridlyTimelineEvent
{
...
public sealed class GridlyDashboardWidgetDefinition
{
    public string Key { get; set; } = string.Empty;
    public string Title { get; set; } = string.Empty;
    public GridlyDashboardWidgetKind Kind { get; set; }
    public string AspectName { get; set; } = string.Empty;
    public int PreferredWidth { get; set; } = 240;
    public int PreferredHeight { get; set; } = 160;
}

public sealed class GridlyAiInsight
{
    public string Title { get; set; } = string.Empty;

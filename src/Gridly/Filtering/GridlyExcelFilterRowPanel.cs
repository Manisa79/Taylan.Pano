...
/// </summary>
public sealed class GridlyExcelFilterRowPanel : Panel
{
    private readonly GridlyView _grid;
    private readonly Dictionary<GridlyColumn, TextBox> _editors = new();
    private readonly System.Windows.Forms.Timer _timer = new() { Interval = 180 };

    public GridlyExcelFilterRowPanel(GridlyView grid)
    {
    ...
    private void ApplyFilters()
    {
        foreach (var pair in _editors)
        {
            ...
            if (string.IsNullOrWhiteSpace(text))
                ...
                _grid.SetColumnFilter(new GridlyColumnFilter { AspectName = aspect, Mode = GridlyFilterMode.Contains, Text = text });
        }

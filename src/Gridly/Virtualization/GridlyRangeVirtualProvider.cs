...
/// </summary>
public interface IGridlyRangeRowProvider : IRowProvider, IProviderChangeNotifier
{
    int PageSize { get; }
...
public sealed class GridlyRangeVirtualProvider : IGridlyRangeRowProvider, IDisposable
{
    ...
    public GridlyRangeVirtualProvider(
    ...
    public object? GetRow(int index)
    {
        ...
        return GridlyVirtualPlaceholder.Create(index);
    }
...
public sealed record GridlyVirtualPlaceholder(int Index, string Text)
{
    public static GridlyVirtualPlaceholder Create(int index) => new(index, "Yükleniyor...");
}

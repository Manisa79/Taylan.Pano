...
/// </summary>
public sealed class GridlyState
{
    ...
    public GridlyLayoutState Layout { get; set; } = new();
    ...
    public static GridlyState FromJson(string json)
        => JsonSerializer.Deserialize<GridlyState>(json) ?? new GridlyState();
}

public sealed class GridlyStatePreset
{
    public string Name { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public string Description { get; set; } = string.Empty;
    public GridlyState State { get; set; } = new();
}

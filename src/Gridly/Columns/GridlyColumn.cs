...
/// <summary>Gridly uyumlu kolon ikon delegate imzası. BrightIdeasSoftware bağımlılığı yoktur.</summary>
public delegate object? GridlyImageGetterDelegate(object rowObject);

/// <summary>Gridly uyumlu kolon text delegate imzası. BrightIdeasSoftware bağımlılığı yoktur.</summary>
public delegate string? GridlyAspectToStringConverterDelegate(object? value);

/// <summary>Gridly uyumluluğu için kolon içi button boyutlama modu.</summary>
public enum GridlyColumnButtonSizing
{
    FixedBounds = 0,
    TextBounds = 1,
    CellBounds = 2
...
public enum GridlyAutoFilterMode
{
    Default = 0,
    Smart = 1,
    Text = 2,
...
public enum GridlyAggregateMode
{
    None = 0,
    Count = 1,
    Sum = 2,
...
public enum GridlyFilterOperator
{
    Contains = 0,
    StartsWith = 1,
    EndsWith = 2,
...
[TypeConverter(typeof(GridlyColumnTypeConverter))]
public class GridlyColumn : Component
{
    ...
    [Description("Hücre içi scroll açıkken görünür maksimum satır sayısı. 0 ise Gridly varsayılan MaxCellTextLines kullanılır.")]
    [DefaultValue(0)]
    ...
    public GridlyColumn()
    {
        Name = GridlyColumnNameHelper.CreateDefaultName(1);
        DefaultWidth = 120;
        DefaultVisible = true;
    }
    public GridlyColumn(string title, string aspectName, int width = 120)
    {
        Header = title;
        AspectName = aspectName;
        Name = GridlyColumnNameHelper.CreateNameFromAspectOrText(aspectName, title);
        Width = width;
        DefaultWidth = width;
        DefaultVisible = true;
    }
    ...
    /// <summary>
    /// Gridly uyumlu kolon kimliği. PropertyGrid'de ayrıca görünmez;
    ...
    // Gridly / DataGridView geçişini kolaylaştıran alias'lar.
    [Category("Gridly - Compatibility"), Browsable(false)]
    ...
    [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] public GridlyAspectToStringConverterDelegate? AspectToStringConverter { get; set; }
    [Category("Gridly - Compatibility"), DefaultValue(null)] public string? AspectToStringFormat { get; set; }
    [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] public GridlyAspectToStringConverterDelegate? ValueToStringConverter { get => AspectToStringConverter; set => AspectToStringConverter = value; }
    [Category("Gridly"), DefaultValue(120)]
    public int Width
    {
        get => _width;
        set
    ...
    [Category("Gridly"), DefaultValue(true)]
    ...
    /// Kolon Gridly kolon düzenleyicisinde görünür kalır; kullanıcı isterse geri alabilir.
    /// Kolon koleksiyonda kalır; AspectName/AspectGetter üzerinden veri erişimi bozulmaz.
    /// </summary>
    [Browsable(true)]
    [Category("Gridly - Behavior")]
    [DisplayName("Private Column")]
    [DefaultValue(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
    [Description("Kolonu dahili/gizli kolon yapar. True yapıldığında kolon tasarım/runtime grid yüzeyinden, runtime kolon seçicisinden, export ve print akışından çıkar; Gridly kolon düzenleyicisinde görünür kalır.")]
    ...
    [Category("Gridly - Smart Filter"), DefaultValue(GridlyAutoFilterMode.Default)]
    ...
    public GridlyAutoFilterMode AutoFilterMode { get; set; } = GridlyAutoFilterMode.Default;

    [Category("Gridly - Smart Filter"), DefaultValue(GridlyFilterOperator.Contains)]
    [Description("Akıllı filtre penceresinde bu kolon için varsayılan operatör.")]
    public GridlyFilterOperator DefaultFilterOperator { get; set; } = GridlyFilterOperator.Contains;

    [Category("Gridly - Smart Filter"), DefaultValue(false)]
    ...
    [Category("Gridly - Search"), DefaultValue(null)]
    ...
    [Category("Gridly - Layout"), DefaultValue(false)]
    ...
    [Category("Gridly - Summary"), DefaultValue(GridlyAggregateMode.None)]
    [Description("Footer/summary alanında bu kolon için hesaplanacak özet türü.")]
    public GridlyAggregateMode Aggregate { get; set; } = GridlyAggregateMode.None;

    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public Func<IEnumerable<object>, GridlyColumn, object?>? CustomAggregateGetter { get; set; }

    [Category("Gridly - Column Manager"), DefaultValue(120)] public int DefaultWidth { get; set; } = 120;
    [Category("Gridly - Column Manager"), DefaultValue(true)] public bool DefaultVisible { get; set; } = true;
    [Category("Gridly - Behavior"), DefaultValue(true)] public bool Sortable { get; set; } = true;
    [Category("Gridly - Behavior"), DefaultValue(true)] public bool Filterable { get; set; } = true;
    [Category("Gridly - Behavior"), DefaultValue(true)] public bool AllowResize { get; set; } = true;
    [Category("Gridly - Behavior"), DefaultValue(true)] public bool AllowReorder { get; set; } = true;
    [Category("Gridly - Behavior"), DefaultValue(true)] public bool AllowGroup { get; set; } = true;
    [Category("Gridly - Behavior"), DefaultValue(true)] public bool AllowColumnChooser { get; set; } = true;
    [Category("Gridly - Behavior"), DefaultValue(true)]
    ...
    [Category("Gridly - Layout"), DefaultValue(-1)] public int MinimumWidth { get; set; } = -1;
    [Category("Gridly - Layout"), DefaultValue(-1)] public int MaximumWidth { get; set; } = -1;
    [Category("Gridly - Layout"), DefaultValue(-1)] public int DisplayIndex { get => _displayIndex; set => _displayIndex = value; }
    [Category("Gridly - Layout"), DefaultValue(false)] public bool WordWrap { get; set; }
    [Category("Gridly - Layout"), DefaultValue(0)]
    [Description("WordWrap aktifken bu kolon için gösterilecek en fazla metin satırı. 0: Gridly genel MaxCellTextLines değerini kullanır.")]
    ...
    [Category("Gridly - Compatibility"), DefaultValue(true)] public bool Searchable { get; set; } = true;
    [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    ...
    [Category("Gridly - Compatibility"), DefaultValue(false)] public bool IsTileViewColumn { get; set; }
    [Category("Gridly - Compatibility"), DefaultValue(0)] public int FreeSpaceProportion { get; set; }
    [Category("Gridly - Compatibility"), DefaultValue(null)] public string? ToolTipText { get; set; }
    [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] public object? Tag { get; set; }

    // Gridly migration aliases. Designer'da kolon bazlı yönetilebilir.
    [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    ...
    // Gridly kolon editörü uyumluluk alanları.
    // Bunların bir kısmı Gridly tarafında doğrudan çizim davranışına bağlanır,
    ...
    public bool CheckBoxes
    {
        ...
        set
        {
            ...
            else if (Kind == GridlyColumnKind.CheckBox)
            {
                HeaderCheckBox = false;
                Kind = GridlyColumnKind.Text;
            }
        }
    }
    [Category("Gridly - Compatibility"), DefaultValue(false)] public bool TriStateCheckBoxes { get; set; }
    [Category("Gridly - CheckBox"), DefaultValue(false)]
    ...
    [Category("Gridly - CheckBox"), DefaultValue("")]
    ...
    [Category("Gridly - Compatibility"), DefaultValue(false)] public bool HeaderCheckBoxDisabled { get; set; }
    [Category("Gridly - Compatibility"), DefaultValue(true)] public bool HeaderCheckBoxUpdatesRowCheckBoxes { get; set; } = true;
    [Category("Gridly - Compatibility"), DefaultValue(false)] public bool CellEditUseWholeCell { get; set; }
    [Category("Gridly - Compatibility"), DefaultValue(false)] public bool EnableButtonWhenItemIsDisabled { get; set; }
    [Category("Gridly - Compatibility"), DefaultValue(false)] public bool Hyperlink { get => Kind == GridlyColumnKind.Hyperlink; set { if (value) Kind = GridlyColumnKind.Hyperlink; } }
    [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    ...
    [Category("Gridly - Compatibility"), DefaultValue(false)] public bool ShowTextInHeader { get; set; }
    [Category("Gridly - Compatibility"), DefaultValue(true)] public bool UseInitialLetterForGroup { get; set; } = true;
    [Category("Gridly - Compatibility"), DefaultValue(true)] public bool AutoCompleteEditor { get; set; } = true;
    [Category("Gridly - Compatibility"), DefaultValue(System.Windows.Forms.AutoCompleteMode.Append)] public System.Windows.Forms.AutoCompleteMode AutoCompleteEditorMode { get; set; } = System.Windows.Forms.AutoCompleteMode.Append;
    [Category("Gridly - Button"), DefaultValue("")]
    ...
    [Category("Gridly - Compatibility"), DefaultValue(-1)] public int ButtonMaxWidth { get; set; } = -1;
    [Category("Gridly - Compatibility"), DefaultValue(typeof(Padding), "0, 0, 0, 0")] public Padding ButtonPadding { get; set; } = Padding.Empty;
    [Category("Gridly - Compatibility"), DefaultValue(typeof(Size), "0, 0")] public Size ButtonSize { get; set; } = Size.Empty;
    [Category("Gridly - Compatibility"), DefaultValue(GridlyColumnButtonSizing.TextBounds)] public GridlyColumnButtonSizing ButtonSizing { get; set; } = GridlyColumnButtonSizing.TextBounds;
    [Category("Gridly - Compatibility"), DefaultValue(typeof(Padding), "0, 0, 0, 0")] public Padding CellPadding { get; set; } = Padding.Empty;
    [Category("Gridly - Compatibility"), DefaultValue(ContentAlignment.MiddleCenter)] public ContentAlignment CellVerticalAlignment { get; set; } = ContentAlignment.MiddleCenter;
    [Category("Gridly - Compatibility"), DefaultValue(null)] public string? GroupWithItemCountFormat { get; set; }
    [Category("Gridly - Compatibility"), DefaultValue(null)] public string? GroupWithItemCountSingularFormat { get; set; }
    [Category("Gridly - Compatibility"), DefaultValue(null)] public Font? HeaderFont { get; set; }
    [Category("Gridly - Compatibility"), DefaultValue(null)] public object? HeaderFormatStyle { get; set; }
    [Category("Gridly - Compatibility"), DefaultValue(null)] public string? HeaderImageKey { get; set; }
    [Category("Gridly - Compatibility"), DefaultValue(-1)] public int HeaderImageIndex { get; set; } = -1;
    [Category("Gridly - Compatibility"), DefaultValue(null)] public string? HeaderToolTipText { get; set; }
    [Category("Gridly - Compatibility"), DefaultValue(null)] public object? Renderer { get; set; }

    [Category("Gridly"), DefaultValue(false)] public bool Editable { get; set; }
    [Category("Gridly - Database"), DefaultValue(false)] public bool ReadOnly { get; set; }
    [Category("Gridly - Database"), DefaultValue(false)] public bool Required { get; set; }
    [Category("Gridly - Database"), DefaultValue(0)] public int MaxLength { get; set; }
    [Category("Gridly - Editing"), DefaultValue(Gridly.Editing.GridlyCellEditorKind.Auto)] public Gridly.Editing.GridlyCellEditorKind EditorType { get; set; } = Gridly.Editing.GridlyCellEditorKind.Auto;
    [Category("Gridly"), DefaultValue(GridlyColumnKind.Text)] public GridlyColumnKind Kind { get; set; } = GridlyColumnKind.Text;
    [Category("Gridly"), DefaultValue(ContentAlignment.MiddleLeft)] public ContentAlignment TextAlign { get; set; } = ContentAlignment.MiddleLeft;

    // v25.18 Gridly header visuals: eski liste kontrolündeki kolon checkbox, dikey başlık, renkli başlık ve başlık ikonu davranışları.
    [Category("Gridly - Header"), DefaultValue(false)]
    ...
    [Category("Gridly - Header"), DefaultValue(CheckState.Unchecked)] public CheckState HeaderCheckState { get; set; } = CheckState.Unchecked;
    [Category("Gridly - Header"), DefaultValue(false)] public bool HeaderCheckBoxThreeState { get; set; }
    [Category("Gridly - Header"), DefaultValue(false)] public bool HeaderTextVertical { get; set; }
    [Category("Gridly - Header"), DefaultValue(0)] public int HeaderTextAngle { get; set; }
    [Category("Gridly - Header"), DefaultValue(ContentAlignment.MiddleLeft)] public ContentAlignment HeaderTextAlign { get; set; } = ContentAlignment.MiddleLeft;
    [Category("Gridly - Header"), DefaultValue(typeof(Color), "Empty")] public Color HeaderForeColor { get; set; } = Color.Empty;
    [Category("Gridly - Header"), DefaultValue(typeof(Color), "Empty")] public Color HeaderBackColor { get; set; } = Color.Empty;
    [Category("Gridly - Header"), DefaultValue(null)] public Image? HeaderImage { get; set; }
    [Category("Gridly - Header"), DefaultValue(ContentAlignment.MiddleLeft)] public ContentAlignment HeaderImageAlign { get; set; } = ContentAlignment.MiddleLeft;
    [Category("Gridly - Header"), DefaultValue(true)] public bool HeaderImageBeforeText { get; set; } = true;
    [Category("Gridly - Header"), DefaultValue(16)] public int HeaderImageSize { get; set; } = 16;

    // Gridly migration aliases. Yeni kullanımda Header* adları tercih edilir.
    [Category("Gridly - Header"), Browsable(false)] public bool HeaderUsesCheckBox { get => HeaderCheckBox; set => HeaderCheckBox = value; }
    [Category("Gridly - Header"), Browsable(false)] public bool HeaderIsVertical { get => HeaderTextVertical; set => HeaderTextVertical = value; }
    [Category("Gridly - Header"), Browsable(false)] public Color HeaderTextColor { get => HeaderForeColor; set => HeaderForeColor = value; }
    [Category("Gridly - Header"), Browsable(false)] public Color HeaderColor { get => HeaderBackColor; set => HeaderBackColor = value; }
    [Category("Gridly - Header"), Browsable(false)] public Image? HeaderIcon { get => HeaderImage; set => HeaderImage = value; }

    [Category("Gridly - Header Icons"), DefaultValue(Gridly.Core.GridlyFilterIconStyle.Inherit)]
    public Gridly.Core.GridlyFilterIconStyle FilterIconStyle { get; set; } = Gridly.Core.GridlyFilterIconStyle.Inherit;

    [Category("Gridly - Header Icons"), DefaultValue(null)]
    public Image? FilterIcon { get; set; }

    [Category("Gridly - Header Icons"), DefaultValue(Gridly.Core.GridlySortGlyphStyle.Inherit)]
    public Gridly.Core.GridlySortGlyphStyle SortGlyphStyle { get; set; } = Gridly.Core.GridlySortGlyphStyle.Inherit;
    ...
    [Category("Gridly - Pinning")]
    [DefaultValue(Gridly.Core.GridlyColumnPinMode.None)]
    [Description("Excel/AG Grid style column pinning metadata. Renderers can keep pinned columns fixed left/right.")]
    public Gridly.Core.GridlyColumnPinMode PinMode { get; set; } = Gridly.Core.GridlyColumnPinMode.None;

    [Category("Gridly - Sparkline")]
    [DefaultValue(false)]
    ...
    [Category("Gridly"), DefaultValue(5)] public int MaxRating { get; set; } = 5;
    [Category("Gridly"), DefaultValue("★")] public string RatingSymbol { get; set; } = "★";
    [Category("Gridly"), DefaultValue(",")] public string TagSeparator { get; set; } = ",";
    [Category("Gridly"), DefaultValue(false)] public bool FillFreeSpace { get; set; }
    [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] public Image? Image { get; set; }
    /// <summary>
    /// Gridly uyumlu kolon bazlı ikon üretici. Image, Icon, Bitmap, string ImageList key,
    /// int ImageList index veya null dönebilir. Eski Gridly kodundaki Image döndüren delegate'ler de çalışır.
    /// </summary>
    [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] public GridlyImageGetterDelegate? ImageGetter { get; set; }

    /// <summary>Gridly benzeri sabit ImageList key/index. ImageGetter yoksa kullanılır.</summary>
    [Category("Gridly - Compatibility"), DefaultValue(null)] public object? ImageKey { get; set; }

    [Category("Gridly - Compatibility"), DefaultValue(-1)] public int ImageIndex { get; set; } = -1;

    /// <summary>Gridly benzeri state image üretici. StateImageList veya SmallImageList üzerinden çözümlenir.</summary>
    [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] public GridlyImageGetterDelegate? StateImageGetter { get; set; }

    [Category("Gridly - Compatibility"), DefaultValue("")] public string ImageAspectName { get; set; } = string.Empty;
    ...
    [Category("Gridly - Editing"), DefaultValue(-999999999)] public decimal NumericMinimum { get; set; } = -999999999m;
    [Category("Gridly - Editing"), DefaultValue(999999999)] public decimal NumericMaximum { get; set; } = 999999999m;
    [Category("Gridly - Editing"), DefaultValue(0)] public int NumericDecimalPlaces { get; set; }
    [Category("Gridly - Editing"), DefaultValue(Gridly.Editing.GridlyDateTimeEditorFormat.Short)] public Gridly.Editing.GridlyDateTimeEditorFormat DateTimeFormat { get; set; } = Gridly.Editing.GridlyDateTimeEditorFormat.Short;
    [Category("Gridly - Editing"), DefaultValue("dd.MM.yyyy HH:mm")] public string DateTimeCustomFormat { get; set; } = "dd.MM.yyyy HH:mm";
    [Category("Gridly - Editing"), DefaultValue(true)] public bool DateTimeNullable { get; set; } = true;
    ...
    private object? TryEvaluateFormula(object row)
    {
        try
        {
            return new GridlyExpressionEngine().Evaluate(row, Formula);
        }
        catch
        {
            return null;
    ...
    /// <summary>
    /// Designer collection list display. Matches the Gridly convention:
    /// olvColumnName (AspectName). For Gridly this becomes glvColumnName (AspectName).
    /// </summary>
    public override string ToString() => DisplayText;
}

public sealed class GridlyColumnTypeConverter : ExpandableObjectConverter
{
    ...
    {
        if (destinationType == typeof(string) && value is GridlyColumn column)

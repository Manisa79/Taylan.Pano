...
internal static class GridlyColumnNameHelper
{
    ...
    public static bool IsDefaultColumnCaption(string? value)
    {
        ...
        return string.Equals(text, "Column", StringComparison.OrdinalIgnoreCase) ||
               string.Equals(text, "GridlyColumn", StringComparison.OrdinalIgnoreCase) ||
               string.Equals(text, "GLVColumn", StringComparison.OrdinalIgnoreCase);
    }

    public static string EnsureUnique(string baseName, IEnumerable<GridlyColumn> existing)
    {
    ...
    public static string GetDesignerDisplayText(GridlyColumn? column)
    {
    ...
    public static bool LooksLikeGeneratedName(string? name)
    {
        ...
        return n.StartsWith(DefaultPrefix + "Column", StringComparison.OrdinalIgnoreCase) ||
               ...
               n.StartsWith("gridlyColumn", StringComparison.OrdinalIgnoreCase) ||
    ...
    public static int GetNextDefaultOrdinal(IEnumerable<GridlyColumn> columns)
    {
        int max = 0;

...
/// <summary>
/// Non-visual database binding helper. It lets Gridly work like a light DataGridView layer:
/// Fill a DataTable, bind it to Gridly, then push Insert/Update/Delete changes with SaveChanges().
...
/// </summary>
public sealed class GridlyDatabaseBindingAdapter
{
    ...
    public GridlyDatabaseBindingAdapter(DbConnection connection, DbDataAdapter adapter, DbCommandBuilder commandBuilder)
    {
    ...
    public void BindTo(GridlyView grid, bool autoGenerateColumns = true, string primaryKey = "")
    {

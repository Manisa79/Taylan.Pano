...
public sealed class GridlyQueryEngine
{
    ...
    private bool EvaluateTerm(object row, string raw)
    {
        ...
        if (colon.Success)
        {
            object? left = GridlyExpressionEngine.GetValue(row, colon.Groups["name"].Value.Trim());
        ...
        foreach (string op in operators)
        {
            ...
            object? left = GridlyExpressionEngine.GetValue(row, name);

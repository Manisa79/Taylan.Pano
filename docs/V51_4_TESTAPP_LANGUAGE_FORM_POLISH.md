# Gridly v1.0.51.4 - TestApp Language Form Polish
...
- Yeni açılan Gridly örnekleri ve built-in menüler seçilen dili kullanır.

## Not

Dil seçimi `settings/gridly-testapp-language.json` içinde saklanır.

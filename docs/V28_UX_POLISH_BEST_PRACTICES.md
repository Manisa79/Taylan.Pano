# Gridly v28 UX Polish + Best Practice Pack
...
DevExpress tarafında filter/search panel ve kolon filtre dropdownları; Telerik tarafında hızlı grouping/filtering/virtualized grid davranışı; Syncfusion tarafında drag-drop, context menu, export/summary gibi enterprise grid beklentileri incelendi. Gridly tarafında bunlar hafif ve WinForms designer dostu property'ler olarak toparlandı.

...
1 trilyon kayıt ancak server-side paging, virtual provider ve index tabanlı veri modeliyle simüle edilir. Gridly tarafında hedef, bu sayıyı belleğe almak değil; görünen aralığı hızlı istemek ve çizmek olmalıdır.

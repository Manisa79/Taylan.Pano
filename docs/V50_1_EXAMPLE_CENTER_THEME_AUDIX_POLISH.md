# Gridly v50.1 - Example Center + Theme + Audix Polish

Bu paket Gridly 5.0 Foundation üzerine pratik kullanım düzenlemesi getirir.
...
- Gridly 5.0 Foundation/Stability örneklerini Example Center Pro içine görünür şekilde bağlamak.
